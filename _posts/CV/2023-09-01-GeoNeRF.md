...
- **Geometry Reasoner 손실 함수:** 기하 정보를 더 정확하게 추론할 수 있도록 함
    ...
    $$
    \mathcal L_D^{(l)} = {2^{-l} \over |V|} \sum_{v=1}^V 
    \left\langle \Vert \hat D_v^{(l)}-D_v^{(l)} \Vert_{s1} \right\rangle
    $$
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/78ca796f-4026-4ad4-abe4-20bb1db57b2d/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/0a7755d6-6444-4e0f-a6c5-a9e709e85d08/Untitled.png)
